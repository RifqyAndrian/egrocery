...
<body class="">
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <li class="nav-item">
                                <a class="btn btn-warning m-2 " style="" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
                            </li>
                            <?php if(Route::has('register')): ?>
                                <li class="nav-item">
                                    <a class="btn btn-warning m-2 " style="" href="<?php echo e(route('register')); ?>"><?php echo e(__('Register')); ?></a>
                                </li>
                            <?php endif; ?>
                        <?php else: ?>
        ...
        <div class="container-fluid p-5 bg-success text-white text-center">
            <a class="navbar-brand text-dark position-absolute" style="right: 440px;" href="<?php echo e(url('/')); ?>">
            ...
            <div class="position-absolute" style="right:200px;">
                <a class="btn btn-sm btn-warning text-dark font-weight-bold" href="<?php echo e(route('logout')); ?>" style=""  onclick="event.preventDefault();
...
<?php /**PATH C:\Users\iqbal\OneDrive\Documents\Freelance\AmazingEbook2022\resources\views/layouts/app.blade.php ENDPATH**/ ?>