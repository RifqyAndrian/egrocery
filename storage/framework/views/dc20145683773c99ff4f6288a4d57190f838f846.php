    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card shadow border-primary">
                <h1 class="text-center py-4 card-header bg-primary">Profle</h1>
                <div class="card-body">
                    <div class="text-center p-2">
                        <img class="img-thumbnail  " src="<?php if(empty($data->photo)): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sujadi\Documents\Folder-Tugas\laravel\AmazingEbook2022\resources\views/profilIndex.blade.php ENDPATH**/ ?>