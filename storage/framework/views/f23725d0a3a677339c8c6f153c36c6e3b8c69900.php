...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select style="" id="name" type="text" class=" form-control  <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label style="" for="email" class="col-md-2 col-form-label text-md-left "><?php echo e(__('E-Mail')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="password" style="" class="col-md-2 col-form-label text-md-left "><?php echo e(__('Password')); ?></label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="text-center">
                                    <a href="<?php echo e(route('login')); ?>">Already Have an account? click here tp login</a>
                                </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\iqbal\OneDrive\Documents\Freelance\AmazingEbook2022\resources\views/auth/register.blade.php ENDPATH**/ ?>